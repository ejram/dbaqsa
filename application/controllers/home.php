...
<<<<<<< HEAD
	...
	public function modify_mark(){
		$mark_name= $_POST['mark_modify_name'];
		$mark_past_name = $_POST['hidden_past_mark_name'];

		$modify_att = array ('mark_value' => $mark_name);
		$this->db->where('mark_id', $mark_past_name);
		$this->db->update('aq_marks', $modify_att);
	}
